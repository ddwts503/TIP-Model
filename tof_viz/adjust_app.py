...
def run_adjust(pc: PointCloud, *, save_csv: Optional[str] = None,
    ...
    app.layout = html.Div([
        ...
        html.Div([
            html.Label("回転 yaw [度](±180まで)"),
            dcc.Slider(-180, 180, 1, value=0, id="yaw",
                       marks={-180: "-180", -90: "-90", 0: "0",
                              90: "90", 180: "180"},
                       tooltip={"placement": "bottom", "always_visible": True}),
            html.Label("左右 dx [mm]"),
            dcc.Slider(-500, 500, 1, value=0, id="dx",
                       marks={-500: "-500", 0: "0", 500: "500"},
                       tooltip={"placement": "bottom", "always_visible": True}),
            html.Label("頭足 dy [mm]"),
            dcc.Slider(-500, 500, 1, value=0, id="dy",
                       marks={-500: "-500", 0: "0", 500: "500"},
                       tooltip={"placement": "bottom", "always_visible": True}),
        ], style={"width": "820px"}),
